...
st.set_page_config(page_title="Smart Stylist powered by computer vision",page_icon=":shopping_bags:")
...
st.divider()
st.info("Check out the gallery in sidebar to get some ideas")
